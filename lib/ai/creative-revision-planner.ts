...
export async function planCreativeRevision(args: {
  ...
  const response = await fetchWithProviderUsage('revision-plan', model, 'https://api.openai.com/v1/responses', {
