...
- `references/ads/` - curated reference creatives and notes
- `assets/brand/` - approved logos and brand assets
- `docs/` - implementation notes and roadmap

## Current Priority

Start with the knowledge base and reference-to-TRA static creative workflow before adding Meta automation.
